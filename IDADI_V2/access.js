(function initializeIdadiAccess(globalScope) {
  "use strict";

  const FORM_CODE = "IDADI_V2";
  const FORM_NAME = "IDADI - Inventário Dimensional de Avaliação do Desenvolvimento Infantil";
