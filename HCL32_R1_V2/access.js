(function initializeHcl32R1Access(globalScope) {
  "use strict";

  const FORM_CODE = "HCL32_R1_V2";
  const FORM_NAME = "HCL-32-R1 - Escala de Autoavaliação de Hipomania";
