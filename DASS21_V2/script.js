...
if (!window.DASS21Data || !window.DASS21Access || !window.DASS21Scoring) {
  throw new Error("Não foi possível carregar os módulos da DASS-21.");
}

const data = window.DASS21Data;
const {
  buildPatientAreaUrl,
  fetchPatientAccess,
...
async function handleSubmit(event) {
  ...
  try {
    if (state.demo) {
      window.__DASS21_DEMO_SUBMISSION__ = {
        results,
