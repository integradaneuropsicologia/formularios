(function initializeDass21Access(globalScope) {
  "use strict";

  const FORM_CODE = "DASS21_V2";
  const FORM_NAME = "DASS-21 - Escala de Depressão, Ansiedade e Estresse";
