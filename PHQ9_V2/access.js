(function initializePhq9Access(globalScope) {
  "use strict";

  const FORM_CODE = "PHQ9_V2";
  const FORM_NAME = "PHQ-9 - Questionário sobre a Saúde do Paciente";
