(function initializeIsslAccess(globalScope) {
  "use strict";

  const FORM_CODE = "ISSL_V2";
  const FORM_NAME = "ISSL - Inventário de Sintomas de Stress para Adultos de Lipp";
