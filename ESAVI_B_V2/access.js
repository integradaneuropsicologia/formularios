(function initializeEsaviBAccess(globalScope) {
  "use strict";

  const FORM_CODE = "ESAVI_B_V2";
  const FORM_NAME = "EsAvI-B - Escala de Avaliação da Impulsividade";
