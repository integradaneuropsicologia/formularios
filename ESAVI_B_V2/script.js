...
if (!window.ESAVIBData || !window.ESAVIBAccess || !window.ESAVIBScoring) {
  throw new Error("Não foi possível carregar os módulos da EsAvI-B.");
}

const data = window.ESAVIBData;
const {
  buildPatientAreaUrl,
  fetchPatientAccess,
...
async function handleSubmit(event) {
  ...
  try {
    if (state.demo) {
      window.__ESAVI_B_DEMO_SUBMISSION__ = {
        results,
