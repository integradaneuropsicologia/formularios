(function initializePsstAccess(globalScope) {
  "use strict";

  const FORM_CODE = "PSST_V2";
  const FORM_NAME = "PSST - Instrumento de Triagem de Sintomas Pré-Menstruais";
  ...
  function mapSubmissionError(error) {
    ...
    if (message.includes("ja preenchido") || message.includes("duplicate") || message.includes("unique")) {
