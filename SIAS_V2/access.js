(function initializeSiasAccess(globalScope) {
  "use strict";

  const FORM_CODE = "SIAS_V2";
  const FORM_NAME = "SIAS - Escala de Ansiedade na Interação Social";
