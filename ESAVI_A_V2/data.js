(function initializeEsaviAData(globalScope) {
  "use strict";
  ...
  const data = {
    formCode: "ESAVI_A_V2",
    formName: "EsAvI-A - Escala de Avaliação da Impulsividade",
    ...
    factors: [
      {
        ...
        itemNumbers: [1, 3, 7, 9, 12, 15, 16, 19, 20, 22, 23, 29],
        reverseItemNumbers: []
      },
      {
        code: "F2",
        name: "Controle cognitivo",
        itemNumbers: [6, 13, 18, 21, 25, 26, 27, 28],
        reverseItemNumbers: []
      },
      {
        code: "F3",
        name: "Planejamento futuro",
        itemNumbers: [2, 4, 14, 17, 31],
        reverseItemNumbers: [2, 14]
      },
      {
        code: "F4",
        name: "Audácia e temeridade",
        itemNumbers: [5, 8, 10, 11, 24, 30],
        reverseItemNumbers: []
      }
    ]
  };
