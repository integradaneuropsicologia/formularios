(function initializeEsaviAAccess(globalScope) {
  "use strict";

  const FORM_CODE = "ESAVI_A_V2";
  const FORM_NAME = "EsAvI-A - Escala de Avaliação da Impulsividade";
