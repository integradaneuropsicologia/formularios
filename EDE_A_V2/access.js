(function initializeEdeaAccess(globalScope) {
  "use strict";

  const FORM_CODE = "EDE_A_V2";
  const FORM_NAME = "EDE-A - Escala de Desregulação Emocional - Versão Adultos";
