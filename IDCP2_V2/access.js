(function initializeIdcp2Access(globalScope) {
  "use strict";

  const FORM_CODE = "IDCP2_V2";
  const FORM_NAME = "IDCP-2 - Inventário Dimensional Clínico da Personalidade";
