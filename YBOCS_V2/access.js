(function initializeYbocsAccess(globalScope) {
  "use strict";

  const FORM_CODE = "YBOCS_V2";
  const FORM_NAME = "Y-BOCS - Escala Yale-Brown de Sintomas Obsessivo-Compulsivos";
